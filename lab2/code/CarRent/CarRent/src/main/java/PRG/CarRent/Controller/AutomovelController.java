...
public class AutomovelController{
    ...
    @Operation(summary = "Cria um automovel")
    @PostMapping()
    ...
    @Operation(summary = "Busca todos os automoveis")
    @GetMapping()
    ...
    @Operation(summary = "Busca um automovel por ID")
    @GetMapping("/{id}")
    ...
    @Operation(summary = "Atualiza um automovel")
    @PutMapping("/{id}")
    ...
    @Operation(summary = "Deleta um automovel")
    @DeleteMapping("/{id}")
